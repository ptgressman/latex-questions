...
\begin{question}[Three Stooges]
This is a short answer question. Name one of the main characters of the Three Stooges. \online{Type the first name only, capitalized. Do not include any spaces.}
\begin{shortanswer}
\choice{Larry}
\choice{Mo}
\choice{Curly}
...
\begin{question}[Question Stub 1]
